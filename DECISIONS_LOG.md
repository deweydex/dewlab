...
**7.112 — The percent format, so a file written here opens elsewhere.**
...
**7.113 — A text cell collapsing on blur swallows the next click.**
...
7.112 work around it deliberately (`add_text_cell()` leaves the cell and
