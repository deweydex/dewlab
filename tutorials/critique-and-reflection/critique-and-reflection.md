...
On [A program of your own](tutorial:a-program-of-your-own) you built
something of your own choosing, and released a first version of it. Before
the team project, this page looks back at it twice: once through your own
eyes, and once through somebody else's.
...
There is no single right time for this page. Come back to it whenever you
finish something big enough to be worth a second look.
...
what they notice. The goal is to practise reading code, which matters at
least as much as writing it. Nobody is judging, and nothing is graded.
...
**What is one thing they did that is especially clear?** Say what makes
it work well: a name, a function doing one job, a docstring that answered
...
Next comes [The Team Project](tutorial:the-team-project): a program built
in a group of three to five, over several weeks, released three times. The
code will feel familiar, from
[From cells to a program](tutorial:from-cells-to-a-program). Building it
together will be new for most people, and the reading you practised in
