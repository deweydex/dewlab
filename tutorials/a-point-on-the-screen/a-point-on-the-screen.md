...
worked this out in the early 1400s, and every picture since then
...
That is what a zoom lens does. We come back to that in [Field of
...
moves the camera, and then sets a ball going round in a circle, with
