...
- learn how to check whether a browser supports something new
...
link. A page was a document, with structure and links. It could
control very little of how it looked.
...
Here is the timeline of both languages. The rest of this page
describes it:
...
HTML appeared in numbered versions for most of the 1990s:
...
| 1997 | HTML 3.2 |
| 1999 | HTML 4.01 |
| 2004 | Progress had stalled for years, so a group of browser makers started their own group to keep improving HTML |
...
it *looks*, from one separate file. Here is the same heading, the way you
would write it now:
...
One rule in `styles.css` now styles every `<h1>` on every page. So your
five pages share one stylesheet.
...
| 2011 | CSS2.1 fixes differences between browsers |

After CSS2.1, CSS stopped appearing as one single specification. CSS3
...
but the standard no longer recommends. Usually CSS replaced it.
...
we are looking at: a page from before CSS. The W3C's HTML
...
| *WHATWG* | A group started by browser makers in 2004. It now writes the HTML standard. | the HTML living standard |
...
#30.* <https://www.youtube.com/watch?v=guvsH5OFizE>. It shows how Tim Berners-Lee's
