...
`<a>` is a link, pointing wherever its `href` says. A *same-site link* is
a filename, pointing at another page of yours. A `mailto:` link opens an
email application instead of a page.
