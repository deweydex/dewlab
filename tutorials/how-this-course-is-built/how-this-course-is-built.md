...
This page has no code and no questions. Read it now, come back later,
or skip it. Nothing on a later page needs it.
...
For some people that works. For someone who has collected a lot of
crosses, it does something quieter. A topic you meet once and never need
again says it was never for you. A formula with no reason is one more
thing to remember, and then one more thing to forget. And a cross tells
you that something happened. It does not tell you what.
...
is fair. The maths and the code arrive because the question needs them.
We use an idea first, and give it its name afterwards.

**Four questions.** [Four questions for any puzzle](tutorial:four-questions)
gives you four questions to ask of anything: What is named here? What
is promised? What happens when? What does this space let us do? They
come back on every page, so you never start from nothing.
...
reads it with you early. An error message is Python saying which move
it could not make, and on which line. It is information about one line
of code. It says nothing about you.

**Everything comes back.** Each page starts with two short questions
from earlier pages, and each unit ends with a page of mixed problems.
...
Every choice costs something, so here are the costs.
...
its own, and you can start there.
...
when you are curious. Some practice pages ask how *you* would have
