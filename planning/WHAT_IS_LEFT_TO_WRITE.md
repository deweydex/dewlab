# What's left to write (retired)

Nothing. This file used to track a twenty-six-outcome backlog; all of it is
written and released. The current sources of truth are
[`STATUS.md`](./STATUS.md) §1 (the tutorial list) and
[`CURRICULUM_MAP.md`](./CURRICULUM_MAP.md) (the outcome-by-outcome
...
already generates is exactly the kind of drift that made this file go stale
in the first place. The original twenty-six-outcome backlog is still
readable in git history at the commit that retired this file.
