...
Written by `dev/pair_results.py` from the saved batches in `sighted/`. Nothing here has been applied to `topics.yaml`.
...
|---|---|---|---|
| Lists, grids and trees (was Grids) | What a grid of numbers is good for (was Matrices) | 2 | no |
...
| Expanding and simplifying | Solving any quadratic, and the answers that are off the number line (was Solving quadratics) | 2 | yes |
...
| Multiplying two brackets together (was Multiplying out to quadratics) | Solving any quadratic, and the answers that are off the number line (was Solving quadratics) | 2 | yes |
| Counting numbers | Solving any quadratic, and the answers that are off the number line (was Solving quadratics) | 2 | yes |
...
| Sine and cosine defined | The angles with exact answers (was Exact trigonometric values) | 2 | yes |
| Sine and cosine defined | Area of any triangle | 2 | yes |
| Right-triangle trigonometry | The Cosine Rule | 2 | yes |
...
| Lists | Writing down a sum over a whole list (was Index and sigma notation) | 2 | yes |
| Lists | Lists | 2 | yes |
...
- **Lists, grids and trees (was Grids)** and **What a grid of numbers is good for (was Matrices)**
  - ruth: Lists, grids and trees (was Grids) first
  - tom: unrelated
- **Iterating a model** and **How far you can trust a model's numbers (was What a model's numbers are worth)**
  ...
  - tom: unrelated
- **Iterating a model** and **Chance, and the random numbers a computer makes (was Probability)**
  - ruth: unrelated
  - tom: Chance, and the random numbers a computer makes (was Probability) first
- **Iterating a model** and **Computer simulation**
  - ruth: unrelated
  - tom: Computer simulation first
- **How far you can trust a model's numbers (was What a model's numbers are worth)** and **Chance, and the random numbers a computer makes (was Probability)**
  - ruth: unrelated
  - tom: Chance, and the random numbers a computer makes (was Probability) first
...
- **Chance, and the random numbers a computer makes (was Probability)** and **Models, and running a model forward (was Modelling versus simulation)**
  - ruth: unrelated
  - tom: Chance, and the random numbers a computer makes (was Probability) first
- **How an algorithm's cost grows (was Algorithmic complexity)** and **Problem-solving strategies**
  ...
  - tom: unrelated
- **Powers** and **Solving any quadratic, and the answers that are off the number line (was Solving quadratics)**
  - ruth: unrelated
  - tom: Powers first
- **Powers** and **How a computer counts: base two and base sixteen (was Binary and hexadecimal)**
  - ruth: Powers first
  - tom: unrelated
- **Powers** and **Taking a quadratic back apart (was Factorising quadratics)**
  - ruth: unrelated
  - tom: Powers first
...
- **Listing outcomes** and **Multiplying the choices (was The counting principle)**
  ...
  - tom: unrelated
- **Counting values into bands (was Frequency tables and histograms)** and **Lists**
  - ruth: unrelated
  - tom: Lists first
...
|---|---|
| CMPS-LO1 | Lists, grids and trees |
...
| CMPS-LO2 | Chance, and the random numbers a computer makes |
...
| MIT-1.10 | Solving any quadratic, and the answers that are off the number line |
...
- Lists, grids and trees (was Grids)
