...
2 saved batches · 524 pairs judged · 553 judgements in total
...
| Probability applied to computing | What a model's numbers are worth | 1 | yes |
...
| Expressions and equations | Factorising quadratics | 1 | yes |
| Expanding and simplifying | Factorising quadratics | 1 | yes |
| Functions and inverses | Graphing sine and cosine | 1 | yes |
| Functions and inverses | Completing the square | 1 | yes |
| Functions and inverses | Limits | 1 | yes |
| Functions and inverses | The derivative | 1 | yes |
| Functions and inverses | Rules for differentiating | 1 | yes |
| Graphing functions | The derivative | 1 | yes |
| Graphing functions | Rules for differentiating | 1 | yes |
| Limits | Rules for differentiating | 1 | yes |
| Equations of lines | Exact trigonometric values | 1 | yes |
| Equations of lines | Area of any triangle | 1 | yes |
| Pythagoras | Exact trigonometric values | 1 | yes |
| Pythagoras | Area of any triangle | 1 | yes |
| Degrees and radians | Exact trigonometric values | 1 | yes |
| Degrees and radians | Area of any triangle | 1 | yes |
| Listing outcomes | Factorials | 1 | yes |
| Listing outcomes | Permutations | 1 | yes |
| Listing outcomes | Combinations | 1 | yes |
| Frequency tables and histograms | When averages mislead | 1 | yes |
| The counting principle | Permutations | 1 | yes |
| The counting principle | Combinations | 1 | yes |
| Factorials | Combinations | 1 | yes |
| Kinds of data | When averages mislead | 1 | yes |
...
None. Every existing arrow survived the pairs that were judged.
...
- Pythagoras and Degrees and radians — every judge said so (1 judgement)
- The history of programming and Testing and debugging — every judge said so (1 judgement)
- The history of programming and Coding standards — every judge said so (1 judgement)
- The history of programming and Working as a team — every judge said so (1 judgement)
- The history of programming and Algorithms in the real world — every judge said so (1 judgement)
- The history of programming and Documented programs — every judge said so (1 judgement)
- The history of programming and Reading error messages — every judge said so (1 judgement)
- Testing and debugging and Comparing languages — every judge said so (1 judgement)
- Coding standards and Comparing languages — every judge said so (1 judgement)
- Coding standards and Documented programs — every judge said so (1 judgement)
- Working as a team and Comparing languages — every judge said so (1 judgement)
- Working as a team and Documented programs — every judge said so (1 judgement)
- Comparing languages and Documented programs — every judge said so (1 judgement)
- Comparing languages and Reading error messages — every judge said so (1 judgement)
...
## Pairs nobody could call

- Testing and debugging and Functions and scope
