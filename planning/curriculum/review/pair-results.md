...
2 saved batches · 95 pairs judged · 190 judgements in total
...
| Comes first | Comes after | Judgements | Agreed |
|---|---|---|---|
| Problem definition and design | Symptoms versus root cause | 2 | yes |
...
| Factorising quadratics | Solving quadratics, including complex roots | 2 | yes |
| Factorising quadratics | Rewriting a curve to find its lowest point (was Completing the square) | 2 | yes |
...
| Graphing functions | Matrices in practice | 2 | yes |
| Equations of lines | The unit circle | 2 | yes |
| Frequency tables and histograms | Averages and spread | 2 | yes |
| Lists and arrays | Frequency tables and histograms | 2 | no |
