...
| `WA-LO2` The use, purpose and attributes of a range of HTML tags, and how browsers render them | 🟩 | [A page is files — Why does this happen?](https://deweydex.github.io/dewlab/tutorials/a-page-is-files.html#why-does-this-happen)<br/>[Headings, paragraphs and emphasis — Why this happens](https://deweydex.github.io/dewlab/tutorials/headings-and-emphasis.html#why-this-happens)<br/>[Images, paths and alt text — Why this happens](https://deweydex.github.io/dewlab/tutorials/images-and-alt-text.html#why-this-happens)<br/>[Navigation — Why this happens](https://deweydex.github.io/dewlab/tutorials/navigation.html#why-this-happens)<br/>[Sections, and the tags that mean something — Why this happens](https://deweydex.github.io/dewlab/tutorials/sections-that-mean-something.html#why-this-happens)<br/>[The skeleton: head and body — Why does this happen?](https://deweydex.github.io/dewlab/tutorials/the-skeleton.html#why-does-this-happen)<br/>[Three kinds of link — Why this happens](https://deweydex.github.io/dewlab/tutorials/three-kinds-of-link.html#why-this-happens)<br/>_used in:_ [A cube in CSS — Why this happens](https://deweydex.github.io/dewlab/tutorials/a-cube-in-css.html#why-this-happens)<br/>_used in:_ [A form — Why this happens](https://deweydex.github.io/dewlab/tutorials/a-form.html#why-this-happens)<br/>_used in:_ [A rule, and where it lives — Why does this happen?](https://deweydex.github.io/dewlab/tutorials/a-rule-and-where-it-lives.html#why-does-this-happen)<br/>_used in:_ [Drawing frames with JavaScript — Why this happens](https://deweydex.github.io/dewlab/tutorials/drawing-frames-with-javascript.html#why-this-happens)<br/>_used in:_ [Drawing frames with JavaScript — The cube again](https://deweydex.github.io/dewlab/tutorials/drawing-frames-with-javascript.html#the-cube-again)<br/>_used in:_ [Drawing frames with JavaScript — Your turn](https://deweydex.github.io/dewlab/tutorials/drawing-frames-with-javascript.html#your-turn)<br/>_used in:_ [Images and file size — Your turn](https://deweydex.github.io/dewlab/tutorials/images-and-file-size.html#your-turn)<br/>_used in:_ [Keyframe animation and the checkbox hack — Why this happens](https://deweydex.github.io/dewlab/tutorials/keyframes-and-the-checkbox-hack.html#why-this-happens)<br/>_used in:_ [Keyframe animation and the checkbox hack — Your turn](https://deweydex.github.io/dewlab/tutorials/keyframes-and-the-checkbox-hack.html#your-turn)<br/>_used in:_ [Several pages, one navigation — Why this happens](https://deweydex.github.io/dewlab/tutorials/pages-and-navigation.html#why-this-happens)<br/>_used in:_ [Quick reference — HTML](https://deweydex.github.io/dewlab/tutorials/quick-reference.html#html) |
...
| `WA-LO13` Work independently to design, build and publish webpages, without needing an ISP's own hosting (dewlab's own equivalent of the descriptor's own phrase is GitHub Pages, free and independent of any commercial host) | 🟩 | [Publish it — Turning it on](https://deweydex.github.io/dewlab/tutorials/publish-it.html#turning-it-on)<br/>[Publish it — Keeping it up to date](https://deweydex.github.io/dewlab/tutorials/publish-it.html#keeping-it-up-to-date)<br/>_used in:_ [A GitHub account — What GitHub actually does](https://deweydex.github.io/dewlab/tutorials/a-github-account.html#what-github-actually-does)<br/>_used in:_ [An editor — No installing anything: GitHub's own editor](https://deweydex.github.io/dewlab/tutorials/an-editor.html#no-installing-anything-githubs-own-editor)<br/>_used in:_ [How the pieces fit — From a change to a published page](https://deweydex.github.io/dewlab/tutorials/how-the-pieces-fit.html#from-a-change-to-a-published-page)<br/>_used in:_ [Publish it — Why the address looks the way it does](https://deweydex.github.io/dewlab/tutorials/publish-it.html#why-the-address-looks-the-way-it-does)<br/>_used in:_ [The two loops — The local loop: save and refresh](https://deweydex.github.io/dewlab/tutorials/the-two-loops.html#the-local-loop-save-and-refresh)<br/>_used in:_ [The two loops — The GitHub loop: commit, push, and wait](https://deweydex.github.io/dewlab/tutorials/the-two-loops.html#the-github-loop-commit-push-and-wait)<br/>_used in:_ [The two loops — Telling the two apart](https://deweydex.github.io/dewlab/tutorials/the-two-loops.html#telling-the-two-apart) |
