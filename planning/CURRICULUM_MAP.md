...
| `MIT-3.5` The limit of a function | 🟩 | [Limits: getting closer without arriving — A hole in a line](https://deweydex.github.io/dewlab/tutorials/approaching-a-limit.html#a-hole-in-a-line)<br/>[Limits: getting closer without arriving — Getting closer without arriving](https://deweydex.github.io/dewlab/tutorials/approaching-a-limit.html#getting-closer-without-arriving)<br/>[Limits: getting closer without arriving — When there is no limit](https://deweydex.github.io/dewlab/tutorials/approaching-a-limit.html#when-there-is-no-limit)<br/>[Limits: getting closer without arriving — Why we need limits](https://deweydex.github.io/dewlab/tutorials/approaching-a-limit.html#why-we-need-limits) |
...
The tutorials mark a term being introduced by putting it in italics the first time it means something particular. **272 terms** are marked that way, and asking two questions of them is free.
...
| *bug* | 11 | 12 |
| *call* | 2 | 6 |
| *changing the subject* | 23 | 24 |
| *closed* | 4 | 22 |
| *complement* | 15 | 20 |
| *cosine* | 29 | 30 |
| *de morgan's laws* | 19 | 20 |
| *design* | 9 | 11 |
| *difference* | 2 | 19 |
| *expression* | 5 | 23 |
| *factorise* | 23 | 25 |
