...
| `WA-LO2` The use, purpose and attributes of a range of HTML tags, and how browsers render them | 🟩 | [HTML: tags, elements and attributes — Why does this happen?](https://deweydex.github.io/dewlab/tutorials/a-page-is-files.html#why-does-this-happen)<br/>[Headings, paragraphs and emphasis — Why this happens](https://deweydex.github.io/dewlab/tutorials/headings-and-emphasis.html#why-this-happens)<br/>[Images, paths and alt text — Why this happens](https://deweydex.github.io/dewlab/tutorials/images-and-alt-text.html#why-this-happens)<br/>[Navigation — Why this happens](https://deweydex.github.io/dewlab/tutorials/navigation.html#why-this-happens)<br/>[Semantic HTML: tags that describe their content — Why this happens](https://deweydex.github.io/dewlab/tutorials/sections-that-mean-something.html#why-this-happens)<br/>[The head and body of a page — Why does this happen?](https://deweydex.github.io/dewlab/tutorials/the-skeleton.html#why-does-this-happen)<br/>[Three kinds of link — Why this happens](https://deweydex.github.io/dewlab/tutorials/three-kinds-of-link.html#why-this-happens)<br/>_used in:_ [A cube in CSS — Why this happens](https://deweydex.github.io/dewlab/tutorials/a-cube-in-css.html#why-this-happens)<br/>_used in:_ [A form — Why this happens](https://deweydex.github.io/dewlab/tutorials/a-form.html#why-this-happens)<br/>_used in:_ [CSS rules and stylesheets — Why does this happen?](https://deweydex.github.io/dewlab/tutorials/a-rule-and-where-it-lives.html#why-does-this-happen)<br/>_used in:_ [Drawing frames with JavaScript — Why this happens](https://deweydex.github.io/dewlab/tutorials/drawing-frames-with-javascript.html#why-this-happens)<br/>_used in:_ [Drawing frames with JavaScript — The cube again](https://deweydex.github.io/dewlab/tutorials/drawing-frames-with-javascript.html#the-cube-again)<br/>_used in:_ [Drawing frames with JavaScript — Your turn](https://deweydex.github.io/dewlab/tutorials/drawing-frames-with-javascript.html#your-turn)<br/>_used in:_ [Images and file size — Your turn](https://deweydex.github.io/dewlab/tutorials/images-and-file-size.html#your-turn)<br/>_used in:_ [Keyframe animation and the checkbox hack — Why this happens](https://deweydex.github.io/dewlab/tutorials/keyframes-and-the-checkbox-hack.html#why-this-happens)<br/>_used in:_ [Keyframe animation and the checkbox hack — Your turn](https://deweydex.github.io/dewlab/tutorials/keyframes-and-the-checkbox-hack.html#your-turn)<br/>_used in:_ [One navigation bar across several pages — Why this happens](https://deweydex.github.io/dewlab/tutorials/pages-and-navigation.html#why-this-happens)<br/>_used in:_ [Quick reference — HTML](https://deweydex.github.io/dewlab/tutorials/quick-reference.html#html) |
...
| `WA-LO4` The principles of good website design: target audience, site objectives, navigation, structure, interface and access speed | 🟩 | [Images and file size — Choosing a format](https://deweydex.github.io/dewlab/tutorials/images-and-file-size.html#choosing-a-format)<br/>[Images and file size — Keeping file size down](https://deweydex.github.io/dewlab/tutorials/images-and-file-size.html#keeping-file-size-down)<br/>[Planning a site — Two site maps](https://deweydex.github.io/dewlab/tutorials/planning-a-site.html#two-site-maps)<br/>[Planning a site — Why this happens](https://deweydex.github.io/dewlab/tutorials/planning-a-site.html#why-this-happens)<br/>_used in:_ [Images and file size — Your turn](https://deweydex.github.io/dewlab/tutorials/images-and-file-size.html#your-turn)<br/>_used in:_ [One navigation bar across several pages — Why this happens](https://deweydex.github.io/dewlab/tutorials/pages-and-navigation.html#why-this-happens)<br/>_used in:_ [Planning a site — Your turn](https://deweydex.github.io/dewlab/tutorials/planning-a-site.html#your-turn)<br/>_used in:_ [Project ideas — Making any of them easy to read](https://deweydex.github.io/dewlab/tutorials/project-ideas.html#making-any-of-them-easy-to-read)<br/>_used in:_ [Your copy of the project starter — Start with the planning document](https://deweydex.github.io/dewlab/tutorials/your-copy-of-the-project-starter.html#start-with-the-planning-document) |
...
| `WA-LO8` Use HTML tags to build a standards-conformant page or site to a given design | 🟩 | [HTML: tags, elements and attributes — Now in your own site](https://deweydex.github.io/dewlab/tutorials/a-page-is-files.html#now-in-your-own-site)<br/>_used in:_ [A form — Your turn](https://deweydex.github.io/dewlab/tutorials/a-form.html#your-turn)<br/>_used in:_ [Headings, paragraphs and emphasis — Your turn](https://deweydex.github.io/dewlab/tutorials/headings-and-emphasis.html#your-turn)<br/>_used in:_ [Images, paths and alt text — Your turn](https://deweydex.github.io/dewlab/tutorials/images-and-alt-text.html#your-turn)<br/>_used in:_ [Images and file size — An images folder](https://deweydex.github.io/dewlab/tutorials/images-and-file-size.html#an-images-folder)<br/>_used in:_ [Navigation — Your turn](https://deweydex.github.io/dewlab/tutorials/navigation.html#your-turn)<br/>_used in:_ [One navigation bar across several pages — Your turn](https://deweydex.github.io/dewlab/tutorials/pages-and-navigation.html#your-turn)<br/>_used in:_ [Project ideas — After you fork the starter](https://deweydex.github.io/dewlab/tutorials/project-ideas.html#after-you-fork-the-starter)<br/>_used in:_ [Semantic HTML: tags that describe their content — Your turn](https://deweydex.github.io/dewlab/tutorials/sections-that-mean-something.html#your-turn)<br/>_used in:_ [The head and body of a page — Now in your own site](https://deweydex.github.io/dewlab/tutorials/the-skeleton.html#now-in-your-own-site)<br/>_used in:_ [Three kinds of link — Your turn](https://deweydex.github.io/dewlab/tutorials/three-kinds-of-link.html#your-turn) |
| `WA-LO9` Use CSS to style a standards-conformant page or site to a given design | 🟩 | [A cube in CSS — Why this happens](https://deweydex.github.io/dewlab/tutorials/a-cube-in-css.html#why-this-happens)<br/>[CSS rules and stylesheets — Why does this happen?](https://deweydex.github.io/dewlab/tutorials/a-rule-and-where-it-lives.html#why-does-this-happen)<br/>[An orbit in pure CSS — Why this happens](https://deweydex.github.io/dewlab/tutorials/an-orbit-in-css.html#why-this-happens)<br/>[An orbit in pure CSS — Why the ball vanishes](https://deweydex.github.io/dewlab/tutorials/an-orbit-in-css.html#why-the-ball-vanishes)<br/>[CSS variables and BEM names — Why this happens](https://deweydex.github.io/dewlab/tutorials/css-variables-and-bem.html#why-this-happens)<br/>[Flexbox first steps — Why this happens](https://deweydex.github.io/dewlab/tutorials/flexbox-first-steps.html#why-this-happens)<br/>[Flexible images — Why this happens](https://deweydex.github.io/dewlab/tutorials/flexible-images.html#why-this-happens)<br/>[States: hover and focus — Why this happens](https://deweydex.github.io/dewlab/tutorials/hover-and-focus.html#why-this-happens)<br/>[Keyframe animation and the checkbox hack — Why this happens](https://deweydex.github.io/dewlab/tutorials/keyframes-and-the-checkbox-hack.html#why-this-happens)<br/>[Media queries — Why this happens](https://deweydex.github.io/dewlab/tutorials/media-queries.html#why-this-happens)<br/>[Named grid areas — Why this happens](https://deweydex.github.io/dewlab/tutorials/named-grid-areas.html#why-this-happens)<br/>[Position, and the sticky header — Why this happens](https://deweydex.github.io/dewlab/tutorials/position-and-the-sticky-header.html#why-this-happens)<br/>[Position, and the sticky header — And the footer](https://deweydex.github.io/dewlab/tutorials/position-and-the-sticky-header.html#and-the-footer)<br/>[Selectors and classes — Why this happens](https://deweydex.github.io/dewlab/tutorials/selectors-and-classes.html#why-this-happens)<br/>[Text and units — Why this happens](https://deweydex.github.io/dewlab/tutorials/text-and-units.html#why-this-happens)<br/>[The box model: padding, border and margin — Why does this happen?](https://deweydex.github.io/dewlab/tutorials/the-box.html#why-does-this-happen)<br/>[Setting a page's width and centring it — Why this happens](https://deweydex.github.io/dewlab/tutorials/the-container.html#why-this-happens)<br/>[Transitions and transforms — Why this happens](https://deweydex.github.io/dewlab/tutorials/transitions-and-transforms.html#why-this-happens)<br/>[Variables and colour — Why this happens](https://deweydex.github.io/dewlab/tutorials/variables-and-colour.html#why-this-happens)<br/>_used in:_ [A cube in CSS — Your turn](https://deweydex.github.io/dewlab/tutorials/a-cube-in-css.html#your-turn)<br/>_used in:_ [A form — Why this happens](https://deweydex.github.io/dewlab/tutorials/a-form.html#why-this-happens)<br/>_used in:_ [A grid gallery — Why this happens](https://deweydex.github.io/dewlab/tutorials/a-grid-gallery.html#why-this-happens)<br/>_used in:_ [A grid gallery — Your turn](https://deweydex.github.io/dewlab/tutorials/a-grid-gallery.html#your-turn)<br/>_used in:_ [An orbit in pure CSS — Your turn](https://deweydex.github.io/dewlab/tutorials/an-orbit-in-css.html#your-turn)<br/>_used in:_ [Cards in a row — Why this happens](https://deweydex.github.io/dewlab/tutorials/cards-in-a-row.html#why-this-happens)<br/>_used in:_ [Cards in a row — Your turn](https://deweydex.github.io/dewlab/tutorials/cards-in-a-row.html#your-turn)<br/>_used in:_ [CSS variables and BEM names — Naming with BEM](https://deweydex.github.io/dewlab/tutorials/css-variables-and-bem.html#naming-with-bem)<br/>_used in:_ [CSS variables and BEM names — Your turn](https://deweydex.github.io/dewlab/tutorials/css-variables-and-bem.html#your-turn)<br/>_used in:_ [Drawing frames with JavaScript — Why this happens](https://deweydex.github.io/dewlab/tutorials/drawing-frames-with-javascript.html#why-this-happens)<br/>_used in:_ [Flexbox first steps — Your turn](https://deweydex.github.io/dewlab/tutorials/flexbox-first-steps.html#your-turn)<br/>_used in:_ [Flexible images — Your turn](https://deweydex.github.io/dewlab/tutorials/flexible-images.html#your-turn)<br/>_used in:_ [States: hover and focus — Your turn](https://deweydex.github.io/dewlab/tutorials/hover-and-focus.html#your-turn)<br/>_used in:_ [Keyframe animation and the checkbox hack — Your turn](https://deweydex.github.io/dewlab/tutorials/keyframes-and-the-checkbox-hack.html#your-turn)<br/>_used in:_ [Media queries — Your turn](https://deweydex.github.io/dewlab/tutorials/media-queries.html#your-turn)<br/>_used in:_ [Named grid areas — Other properties from the same lesson](https://deweydex.github.io/dewlab/tutorials/named-grid-areas.html#other-properties-from-the-same-lesson)<br/>_used in:_ [Named grid areas — Your turn](https://deweydex.github.io/dewlab/tutorials/named-grid-areas.html#your-turn)<br/>_used in:_ [A navigation that works on a phone — Why this happens](https://deweydex.github.io/dewlab/tutorials/navigation-on-a-phone.html#why-this-happens)<br/>_used in:_ [A navigation that works on a phone — Your turn](https://deweydex.github.io/dewlab/tutorials/navigation-on-a-phone.html#your-turn)<br/>_used in:_ [Position, and the sticky header — Your turn](https://deweydex.github.io/dewlab/tutorials/position-and-the-sticky-header.html#your-turn)<br/>_used in:_ [Project ideas — After Flexbox and Grid](https://deweydex.github.io/dewlab/tutorials/project-ideas.html#after-flexbox-and-grid)<br/>_used in:_ [Quick reference — CSS](https://deweydex.github.io/dewlab/tutorials/quick-reference.html#css)<br/>_used in:_ [Selectors and classes — Your turn](https://deweydex.github.io/dewlab/tutorials/selectors-and-classes.html#your-turn)<br/>_used in:_ [Text and units — Your turn](https://deweydex.github.io/dewlab/tutorials/text-and-units.html#your-turn)<br/>_used in:_ [The box model: padding, border and margin — Now in your own site](https://deweydex.github.io/dewlab/tutorials/the-box.html#now-in-your-own-site)<br/>_used in:_ [Setting a page's width and centring it — Your turn](https://deweydex.github.io/dewlab/tutorials/the-container.html#your-turn)<br/>_used in:_ [Transitions and transforms — Your turn](https://deweydex.github.io/dewlab/tutorials/transitions-and-transforms.html#your-turn)<br/>_used in:_ [Variables and colour — Your turn](https://deweydex.github.io/dewlab/tutorials/variables-and-colour.html#your-turn) |
| `WA-LO10` Test a website's functioning and fix any issues found (the descriptor's own outcome also names cross-browser testing; dewlab teaches diagnosis with a single browser's own developer tools instead) | 🟩 | [The browser inspector — Elements: the page's actual structure](https://deweydex.github.io/dewlab/tutorials/the-inspector.html#elements-the-pages-actual-structure)<br/>[The browser inspector — Console: where errors show up](https://deweydex.github.io/dewlab/tutorials/the-inspector.html#console-where-errors-show-up)<br/>[Troubleshooting — A page or a style doesn't look right](https://deweydex.github.io/dewlab/tutorials/troubleshooting.html#a-page-or-a-style-doesnt-look-right)<br/>[Troubleshooting — My code has a mistake I can't find](https://deweydex.github.io/dewlab/tutorials/troubleshooting.html#my-code-has-a-mistake-i-cant-find)<br/>_used in:_ [A form — Your turn](https://deweydex.github.io/dewlab/tutorials/a-form.html#your-turn)<br/>_used in:_ [A navigation that works on a phone — Why this happens](https://deweydex.github.io/dewlab/tutorials/navigation-on-a-phone.html#why-this-happens)<br/>_used in:_ [A navigation that works on a phone — Your turn](https://deweydex.github.io/dewlab/tutorials/navigation-on-a-phone.html#your-turn)<br/>_used in:_ [The browser inspector — Opening it](https://deweydex.github.io/dewlab/tutorials/the-inspector.html#opening-it) |
...
| `WA-LO13` Work independently to design, build and publish webpages, without needing an ISP's own hosting (dewlab's own equivalent of the descriptor's own phrase is GitHub Pages, free and independent of any commercial host) | 🟩 | [Publishing your site with GitHub Pages — Turning it on](https://deweydex.github.io/dewlab/tutorials/publish-it.html#turning-it-on)<br/>[Publishing your site with GitHub Pages — Keeping it up to date](https://deweydex.github.io/dewlab/tutorials/publish-it.html#keeping-it-up-to-date)<br/>_used in:_ [A GitHub account — What GitHub actually does](https://deweydex.github.io/dewlab/tutorials/a-github-account.html#what-github-actually-does)<br/>_used in:_ [An editor — No installing anything: GitHub's own editor](https://deweydex.github.io/dewlab/tutorials/an-editor.html#no-installing-anything-githubs-own-editor)<br/>_used in:_ [The tools for building a website — From a change to a published page](https://deweydex.github.io/dewlab/tutorials/how-the-pieces-fit.html#from-a-change-to-a-published-page)<br/>_used in:_ [Publishing your site with GitHub Pages — Why the address looks the way it does](https://deweydex.github.io/dewlab/tutorials/publish-it.html#why-the-address-looks-the-way-it-does)<br/>_used in:_ [Saving and publishing a change — The local loop: save and refresh](https://deweydex.github.io/dewlab/tutorials/the-two-loops.html#the-local-loop-save-and-refresh)<br/>_used in:_ [Saving and publishing a change — The GitHub loop: commit, push, and wait](https://deweydex.github.io/dewlab/tutorials/the-two-loops.html#the-github-loop-commit-push-and-wait)<br/>_used in:_ [Saving and publishing a change — Telling the two apart](https://deweydex.github.io/dewlab/tutorials/the-two-loops.html#telling-the-two-apart) |
