...
def run_choice(probe, choice):
    ...
    choice: the command typed, as text: burn, refuel, status or quit. burn
    uses 10 kg, and refuel adds 20 kg. Any other text prints that it is
    not a command, and the mission goes on.
    """
    if choice == "burn":
        probe.burn(10)
        print(probe)
