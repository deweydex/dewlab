...
class TestPreRunTooltips:
    """Jedi answers hover docs and signature help for a name that has never run, the one gap docFor/signatureFor can't close since they only read a live namespace."""
